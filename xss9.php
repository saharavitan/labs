      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1>XSS - Level 5</h1><br><br>
                ...
                <form>
                what is your name ? <br><br> <input type="text" name="name" value="<?php if(isset($_GET['username'])){echo $_GET['username']; } ?>" id="guest" placeholder="David Cohen"> 
                <input type="submit" id="search" value="Go" style="margin-top:20px;"/>
                </form>
                <br>
                <script>
                console.log('<?php echo $_GET['name']?>');
                </script>
